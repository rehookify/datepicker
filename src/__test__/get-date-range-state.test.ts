...
describe('getDateRangeState', () => {
  ...
  test('getDateRangeState should return in-range', () => {
    ...
    expect(getDateRangeState(d1, null, selectedDates1)).toBe('in-range');
  });

  test('getDateRangeState should return range-start', () => {
    expect(getDateRangeState(selectedDates1[0], null, selectedDates1)).toBe(
      'range-start',
    );
  });

  test('getDateRangeState should return range-end', () => {
    expect(getDateRangeState(selectedDates1[1], null, selectedDates1)).toBe(
      'range-end',
    );
  });
  ...
  test('getDateRangeState should return empty string', () => {
    ...
    expect(getDateRangeState(d1, null, selectedDates1)).toBe('');

    const d2 = new Date(2022, 10, 26);
    expect(getDateRangeState(d2, null, selectedDates1)).toBe('');
  });
  ...
  test('getDateRangeState should return will-be-in-range', () => {
    ...
    expect(getDateRangeState(d1, rangeEnd, selectedDates2)).toBe(
      'will-be-in-range',
    );

    const d2 = new Date(2022, 20, 18);
    const rangeEnd2 = new Date(2022, 20, 16);
    expect(getDateRangeState(d2, rangeEnd2, selectedDates2)).toBe(
      'will-be-in-range',
    );
  });
  ...
  test('getDateRangeState should return will-be-range-start', () => {
    ...
    expect(getDateRangeState(selectedDates2[0], rangeEnd, selectedDates2)).toBe(
      'will-be-range-start',
    );
  });
  ...
  test('getDateRangeState should return will-be-range-end', () => {
    const rangeEnd = new Date(2022, 20, 22);
    expect(getDateRangeState(rangeEnd, rangeEnd, selectedDates2)).toBe(
      'will-be-range-end',
    );
  });
  ...
  test('getDateRangeState should return empty string', () => {
    ...
    expect(getDateRangeState(d1, rangeEnd, selectedDates2)).toBe('');
    expect(getDateRangeState(d2, rangeEnd, selectedDates2)).toBe('');
  });
});
